...
public class OwnerRepositoryInMemoryImpl implements OwnerRepository {
	...
	public List<Owner> findByLastName(String lastName) {
		// TODO:Development[return without lambda]
